...
def menu():
    ...
    print('3. Delete Stok')
    print('4. Pemesanan Mobil')
    print('5. Pengembalian mobil')
    print('6. Pencarian berdasarkan transmisi')
    print('7. Selesai')
    print('_______________________________________')
...
while True:
    try:
        ...
        if pilihan_menu == '1':
            ...
            if password() == True:
                hapus()
        elif pilihan_menu == '4': #Pemesanan
            stock()
            pemesanan()
        elif pilihan_menu == '5': #pengembalian
            pengembalian()
        elif pilihan_menu == '6': #pencarian mobil berdasarkan transmisi
            while True:
